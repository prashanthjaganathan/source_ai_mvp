"""change_frequency_hours_to_seconds

Revision ID: 82b0c38e4e6b
Revises: 9a63515141f6
Create Date: 2025-09-14 20:12:15.137540
...
revision: str = '82b0c38e4e6b'
down_revision: Union[str, None] = '9a63515141f6'
...
def upgrade() -> None:
    ...
    op.drop_index('ix_user_capture_settings_id', table_name='user_capture_settings')
    op.drop_index('ix_user_capture_settings_user_id', table_name='user_capture_settings')
    op.drop_table('user_capture_settings')
    op.drop_table('api_clients')
    op.drop_table('earning_balances')
    op.drop_table('earning_events')
    op.drop_table('user_consent')
    op.drop_index('ix_capture_sessions_id', table_name='capture_sessions')
    ...
    op.drop_index('idx_access_audit_created_at', table_name='access_audit')
    ...
    op.drop_index('idx_photos_originalkey_version', table_name='photos')
...
def downgrade() -> None:
    ...
    sa.Column('frequency_hours', sa.INTEGER(), autoincrement=False, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('user_id', sa.VARCHAR(length=255), autoincrement=False, nullable=False),
    sa.Column('collection_frequency_hours', sa.INTEGER(), autoincrement=False, nullable=False),
